...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_testimonials_service" AS ENUM('websites', 'seo', 'marketing', 'ai', 'it');
  CREATE TYPE "public"."enum_testimonials_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'editor');
  CREATE TYPE "public"."enum_form_submissions_source" AS ENUM('contact_form', 'book_call_modal');
  CREATE TYPE "public"."enum_form_submissions_locale" AS ENUM('el', 'en');
  CREATE TYPE "public"."enum_form_submissions_status" AS ENUM('new', 'in_progress', 'replied', 'archived');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('facebook', 'instagram', 'linkedin', 'x');
  CREATE TABLE "pages" (
  ...
  CREATE TABLE "testimonials" (
  	...
  	"avatar_id" integer,
  	"service" "enum_testimonials_service",
  ...
  CREATE TABLE "form_submissions" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"source" "enum_form_submissions_source" NOT NULL,
  	"locale" "enum_form_submissions_locale",
  	"name" varchar NOT NULL,
  	"email" varchar NOT NULL,
  	"phone" varchar,
  	"company" varchar,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Nouvo',
